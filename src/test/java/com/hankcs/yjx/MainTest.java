...
//		getSegement();
	...
	private static void getDuanaYu() {
		  String text = "算法工程师\n"
	...
	private static void getZhaiYao() {
		...
		List<String> setenceList = HanLP.extractKeyword(content, 3);
		System.out.println(setenceList);
	}

	private static void getMainIdea() {
	...
	private static void getSegement() {
